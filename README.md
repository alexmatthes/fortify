...
*(Add a screenshot or GIF of the Dashboard charts animating or the Metronome toggling here)*
...
The project includes unit tests via Jest to ensure reliability.
