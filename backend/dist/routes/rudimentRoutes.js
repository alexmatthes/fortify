...
const rudimentController = __importStar(require("../controllers/rudimentController"));
...
router.delete('/:id', auth_1.default, (0, asyncHandler_1.asyncHandler)(rudimentController.deleteRudiment));
router.get('/:id/suggested-tempo', auth_1.default, (0, asyncHandler_1.asyncHandler)(rudimentController.getSuggestedTempo));
