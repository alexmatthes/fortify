	...
	return (
		<div className="min-h-screen bg-dark-bg text-white flex flex-col font-sans">
			...
			<main className="max-w-4xl mx-auto px-6 py-12 flex-grow">
				<div className="mb-12">
					<h1 className="text-5xl font-bold mb-6 text-center">About Fortify</h1>
				...
				<section className="mb-12">
					...
					<div className="bg-card-bg border border-gray-800 rounded-xl p-8 space-y-4">
				...
				<section className="mb-12">
					...
					<div className="grid md:grid-cols-2 gap-6">
						<div className="bg-card-bg border border-gray-800 rounded-xl p-6">
							<h3 className="text-xl font-bold mb-3 text-primary">Math, Not Magic</h3>
						...
						<div className="bg-card-bg border border-gray-800 rounded-xl p-6">
							<h3 className="text-xl font-bold mb-3 text-primary">Always Ready</h3>
						...
						<div className="bg-card-bg border border-gray-800 rounded-xl p-6">
							<h3 className="text-xl font-bold mb-3 text-primary">Own Your Data</h3>
				...
				<section className="mb-12">
					...
					<div className="bg-card-bg border border-gray-800 rounded-xl p-8 space-y-6">
						<div>
				...
				<section className="bg-card-bg border border-gray-800 rounded-xl p-8 text-center">
					<h2 className="text-2xl font-bold mb-4">Ready to Start?</h2>
					<p className="text-gray-400 mb-6">Join drummers who are building speed the systematic way.</p>
					<Link to="/signup" className="inline-block bg-primary hover:bg-primary-hover text-dark-bg font-bold py-3 px-8 rounded-lg transition-colors">
						Get Started Free
					</Link>
				</section>
			</main>
