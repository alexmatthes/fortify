...
const Metronome: React.FC = () => {
	...
	// 3. Wrap functions in useCallback so they are stable (don't change on every render)
	...
	}, [nextNote, scheduleNote]); // Dependencies are now stable
	...
	}, [scheduler]); // <--- Now scheduler is safe to include!
